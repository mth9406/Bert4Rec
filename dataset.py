...
class RecSysDataset(Dataset):
    ...
    def __init__(self, data):
        self.data = data
        # data[0]: sessions, ex) [[1,2,3], [3,4], [5,7], [1], ...]
        # use collate_fn to match the length before make a batch.
        # data[1]: target items, ex) [4, 5, 2, 2, ...]
        print('-'*50)
        print('Dataset info:')
        print(f'Number of sessions: {len(data[0])}')
        print('-'*50)
